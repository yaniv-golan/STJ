...
```bash
python tools/python/stj_validator.py examples/latest/simple.stj.json
```
...
```bash
python tools/python/stj_to_srt.py examples/latest/simple.stj.json output.srt
```
...
[STJ Specification](spec/latest.md)
